...
function getAppleDevices(callback) {
    exec('system_profiler SPBluetoothDataType 2>/dev/null', (profilerError, profilerOutput) => {
        ...
        exec(cmd, (error, stdout) => {
            ...
            let currentDevice = { name: null, battery: undefined, address: null, isCharging: false };
            ...
            for (const line of lines) {
                ...
                if (addressMatch) {
                    ...
                    currentDevice = { name: null, battery: undefined, address: addressMatch[1], isCharging: false };
